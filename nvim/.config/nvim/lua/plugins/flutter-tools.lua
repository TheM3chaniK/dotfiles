if vim.fn.isdirectory(vim.fn.expand("~/.config/flutter/flutter")) == 1 then
  return {
    ...
    config = function()
      ...
      require("flutter-tools").setup {
        ...
        flutter_path = vim.fn.expand("~/.config/flutter/flutter/bin/flutter"), -- <-- this takes priority over the lookup
        ...
        lsp = {
          ...
          settings = {
            ...
            analysisExcludedFolders = { vim.fn.expand("~/.config/flutter/flutter/") },
      ...
      keymap("n", "<leader>FR", "<cmd>FlutterRun<cr>", { desc = "Flutter: Run App" })
      keymap("n", "<leader>FQ", "<cmd>FlutterQuit<cr>", { desc = "Flutter: Quit App" })
      keymap("n", "<leader>Fr", "<cmd>FlutterRestart<cr>", { desc = "Flutter: Hot Restart" })
      keymap("n", "<leader>FH", "<cmd>FlutterReload<cr>", { desc = "Flutter: Hot Reload" })
      keymap("n", "<leader>FD", "<cmd>FlutterDevices<cr>", { desc = "Flutter: Select Device" })
      keymap("n", "<leader>FL", "<cmd>FlutterLogToggle<cr>", { desc = "Flutter: Toggle Logs" })
      keymap("n", "<leader>FO", "<cmd>FlutterOutlineToggle<cr>", { desc = "Flutter: Toggle Outline" })
      keymap("n", "<leader>FT", "<cmd>FlutterDevTools<cr>", { desc = "Flutter: Open DevTools" })
      keymap("n", "<leader>FW", "<cmd>FlutterVisualDebug<cr>", { desc = "Flutter: Toggle Widget Inspector" })
    end
  }
else
  return {}
